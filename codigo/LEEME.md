...
```bash
cd 02-estrategia
javac -encoding UTF-8 -d /tmp/out1 v1-condicionales/*.java && java -cp /tmp/out1 Main1
javac -encoding UTF-8 -d /tmp/out2 v2-estrategia/*.java   && java -cp /tmp/out2 Main1
...
```bash
cd 03-singleton
javac -encoding UTF-8 -d /tmp/out3 *.java && java -cp /tmp/out3 Main1
```
